...
export default function Drawer1(props) {
  ...
  return (
    <>
      ...
      <Drawer style={{ padding: '0px', zIndex: '9999' }}
        placement="left"
        closable={false}
        maskClosable={true}
        ...
        <div className='header' style={{ background: '#232f3e', width: '365px', height: '50px', position: 'relative' }} >
        ...
        <div className='sidemenu' style={{ position: 'relative' }} >
